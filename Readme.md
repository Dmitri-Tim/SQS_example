# PoC for trxFeeCalculation process

Run java files LongSending, LongPolling, LongPolling2, LongPolling3, LongPolling4 to simulate one sender with multiple receivers


# Original Amazon SQS Java code examples
